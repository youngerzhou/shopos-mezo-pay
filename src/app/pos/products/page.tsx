  ...
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-5 text-slate-950">
      <section className="mx-auto max-w-md rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <h1 className="mt-4 text-2xl font-black">Products</h1>
        <p className="mt-2 text-sm font-bold text-slate-500">Product management placeholder for the mobile admin demo.</p>
      </section>
    </main>
  );
}
